...
| 2 | 7A | Space-Track CDM RTN 共分散の自動取得強化 | 未着手 |
...
## 5. Phase 7A / 7B（ロードマップのみ）

### 7A — Space-Track CDM 強化

- Phase 5C スコープ外だった「Space-Track フル CDM（RTN 共分散）自動取得」
- `cdm_public` から RTN σ をパースし compare-alert / 一覧 Pc に自動反映
