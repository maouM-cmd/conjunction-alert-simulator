...
| **3** | **7B** | Slack Bot / OAuth（Incoming Webhook から Bot へ） | **完了** |
...
- 詳細: [requirements-phase7b.md](requirements-phase7b.md)
- `ALERT_WEBHOOK_FORMAT=slack_bot` + `chat.postMessage`
- Incoming Webhook 互換維持、`/health` で配信モード表示

---

## 7. Phase 7 Ship — v1.2.0 — **完了**

- tag `v1.2.0` + GitHub Release
- [`RELEASE_NOTES_v1.2.0.md`](RELEASE_NOTES_v1.2.0.md)、[`CHANGELOG.md`](../CHANGELOG.md) 更新
- README / Zenn 原稿（[`blog-zenn.md`](demo/blog-zenn.md)）に Phase 7 反映
...
- [Phase 7B](requirements-phase7b.md) — Slack Bot Token 通知
