...
大規模コンステ（1,000+ 衛星）向け運用ワークフロー拡張の要件は **[requirements-commercial-ops.md](requirements-commercial-ops.md)** を参照。Phase 9A: [requirements-phase9a.md](requirements-phase9a.md)、9B: [requirements-phase9b.md](requirements-phase9b.md)、9C: [requirements-phase9c.md](requirements-phase9c.md)。
